...
const accessoriesData = [
  {
    ...
    name: 'Helmet',
    price: 5,
    image: 'https://images.pexels.com/photos/5837013/pexels-photo-5837013.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    description: 'Safety first! Our comfortable helmets provide protection during your ride.',
  },
  {
    id: 2,
    name: 'Bike Lock',
    price: 3,
    image: 'https://images.pexels.com/photos/5082593/pexels-photo-5082593.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    description: 'Secure your bike when you stop to explore with our heavy-duty locks.',
  },
  {
    id: 3,
    name: 'Water Bottle',
    price: 2,
    image: 'https://images.pexels.com/photos/5749068/pexels-photo-5749068.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    description: 'Stay hydrated on your journey with our 24oz reusable water bottle.',
  },
  {
    id: 4,
    name: 'Phone Mount',
    price: 4,
    image: 'https://images.pexels.com/photos/1069798/pexels-photo-1069798.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    description: 'Keep your phone accessible for navigation and photos with our secure mount.',
  },
  {
    id: 5,
    name: 'Bike Lights',
    price: 6,
    image: 'https://images.pexels.com/photos/1409969/pexels-photo-1409969.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
  ...
  },
  {
    ...
    name: 'Basket',
    price: 8,
    image: 'https://images.pexels.com/photos/1127190/pexels-photo-1127190.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
  ...
  },
  {
    ...
    name: 'Child Seat',
    price: 15,
    image: 'https://images.pexels.com/photos/3705328/pexels-photo-3705328.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    description: 'Safe and comfortable seat for young riders to join your adventure.',
  },
];

const Accessories = () => {
  const { booking, addAccessory, removeAccessory, updateAccessoryQuantity, calculateTotal } = useBooking();
  ...
  const totalItems = booking.accessories.reduce((sum, item) => sum + item.quantity, 0);
                  ...
                  >
                    ...
                    <div className="p-4">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <span className="font-medium text-primary-600">${accessory.price}/day</span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          {getQuantity(accessory.id) > 0 ? 'Add More' : 'Add to Booking'}
                        </button>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                {booking.accessories.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-neutral-400">Add some accessories to enhance your ride!</p>
                  </div>
                ) : (
                  <>
                    <div className="space-y-4 mb-4">
                      {booking.accessories.map(item => (
                        <div key={item.id} className="flex justify-between items-center border-b border-neutral-100 pb-3">
                          <div>
                            <h4 className="font-medium">{item.name}</h4>
                            <div className="text-neutral-500 text-sm">${item.price} × {item.quantity}</div>
                          </div>
