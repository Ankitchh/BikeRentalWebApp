...
const AdminNav = () => {
  ...
  return (
    <aside
      ...
      className="fixed top-0 left-0 z-40 w-[19vw] h-screen transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[#2F3243]">
        <ul className="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Manage Bike</span>
            </Link>
          </li>
          <li>
            <Link
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Pacakages</span>
            </Link>
          </li>
          <li>
            <Link
